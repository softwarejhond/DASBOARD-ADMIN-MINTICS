                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($row['statusAdmin'] == '1') {
                            ...
                            echo '<a class="btn bg-danger w-100" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-placement="top" title="RECHAZADO"><i class="bi bi-x-circle"></i></a>';
                        } elseif ($row['statusAdmin'] == '3') {
                            echo '<a class="btn bg-success w-100" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-placement="top" title="MATRICULADO"><i class="bi bi-check-circle-fill"></i></a>';
                        }
                        ?>
                    </td>
