        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($row['id_formulario'] ?? 'No asignado'); ?></td>
                    <td><?php echo htmlspecialchars($row['formulario'] ?? 'No asignado'); ?></td>
...
<div class="modal fade" id="deleteModal<?php echo $cedula; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel<?php echo $cedula; ?>" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white item-align-center">
                <h5 class="modal-title text-center" id="deleteModalLabel<?php echo $cedula; ?>">Confirmación de eliminación</h5>
            </div>
            <div class="modal-body">
                <h5>Nombre: <strong><?php echo htmlspecialchars($nombreCompleto); ?></strong></h5>
                ...
                <div class="alert alert-warning">
                    ...
                    <div class="code-container mt-2 mb-3 p-2 bg-light">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" type="button" id="copyBtn<?php echo $cedula; ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="confirmCode<?php echo $cedula; ?>" placeholder="Ingresa el código de 6 caracteres">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-danger" id="deleteBtn<?php echo $cedula; ?>" disabled>Eliminar</button>
            </div>
        </div>
    </div>
</div>
